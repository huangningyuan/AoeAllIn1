...
def adding_switch(data: DatFile):
    ...
    activate_switch_tech.research_locations.append(ResearchLocation(constants.TC_ID, 1, 14, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.BARRACK_ID, 1, 14, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.STABLE_ID, 1, 14, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.ARCHERY_RANGE_ID, 1, 14, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.SIEGE_ID, 1, 14, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.CASTLE_ID, 1, 10, -1))
    ...
    activate_switch_tech.research_locations.append(ResearchLocation(constants.MARKET_ID, 1, 4, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.UNIV_ID, 1, 14, -1))
    activate_switch_tech.research_locations.append(ResearchLocation(constants.MONESTARY_ID, 1, 14, -1))
    ...
    activate_switch_tech.research_locations.append(ResearchLocation(constants.DOCK_ID, 1, 14, -1))
